...
return array(
  'title'      => esc_html__( 'Hero Header Banner', 'diol' ),
  'categories' => array( 'diol', 'Hero Header Banner' ),
  'content'    => 
  
'<!-- wp:cover {
    "url":"' . esc_url( get_theme_file_uri( '/assets/images/hero-header-banner.jpg' ) ) . '"
    ,"dimRatio":40
      ...
      <!-- wp:group {
        ...
        <div 
          ...
          <!-- wp:heading {
            ...
            <h2 class="has-text-align-left has-foreground-color has-text-color has-carnival-lite-poppins-font-family" style="margin-bottom:var(--wp--preset--spacing--60);font-size:45px;font-style:normal;font-weight:700;text-transform:none">Reliable Logistics<br>Agency With Best<br>Equipment</h2>
          <!-- /wp:heading -->
